...
namespace FormsGallery.ViewModels
{
    public class ListViewDemoPageViewModel : ViewModelBase
    {
        ...
        public Command RefleshCommand { get; private set; }

        private bool isRefleshing = false;
        public bool IsRefleshing
        {
            get => isRefleshing;
            set
            {
        ...
        {
            RefleshCommand = new Command(RefleshAsync);
        }

        private async void RefleshAsync()
        {
